...
int g_ledPin = 4;  //green LED pin 5
int y_ledPin = 5;  //yellow LED pin 6
int r_ledPin = 6;  //red LED pin 9
int b_ledPin = 7; //blue LED pin 10
int ledPins[] = {4, 5, 6, 7};  //array with all the LED's pins
...
void loop(){
  ...
  if (irrecv.decode(&results)){
   ...
   switch (results.value){
      case 16605343: //when you press the Forward button
      ...
      case 16589023: //when you press the Reverse button
      ...
      case 16621663: //when you press the Mute button
